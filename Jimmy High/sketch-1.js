...
gi = loadImage("ground.png");
 ...
 jimmyImage1 = loadImage("playerrun.png");
jimmyImage2 = loadImage("playerkick.png");
jimmyImage3 = loadImage("playerfall.png");
deskImage = loadImage("desk.png");
BG1 = loadImage("BG1");
BG2 = loadImage("BG2");
boxImage = loadImage("locker.png");
...
text("Score:"+score,windowWidth-200,windowHeight-500);
    if(keyDown(UP_ARROW)){
        jimmy.y-=50
        jimmy.addImage("run",jimmyImage1);
    }
    if(keyDown(DOWN_ARROW)){

        jimmy.y+=3
        jimmy.addImage("slide",jimmyImage2);
        jimmy.scale= 0.8;
       // Jreturn();
...
function reset(){
  //  gameOver.visible = false;
    restart.visible = false;
    jimmy.changeImage("run", jimmyImage1);
    score=0;
    gameState=0;
  boxGroup.destroyEach();
  dg.destroyEach();
